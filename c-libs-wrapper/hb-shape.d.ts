...
interface WasmModule {
  ...
  _hb_buffer_reset(_0: number): void;
  ...
  _hb_buffer_clear_contents(_0: number): void;
  ...
  _hb_buffer_add_utf32(_0: number, _1: number, _2: number, _3: number, _4: number): void;
  _hb_language_from_string(_0: number, _1: number): number;
  _hb_script_from_iso15924_tag(_0: number): number;
